...
<div style={{ display: "flex", gap: "16px" }}>
  <ButtonContained
    text="View Android Repository"
    linkTo="https://github.com/smswithoutborders/RelaySMS-Android"
  />
  <ButtonContained
    text="View iOS Repository"
    linkTo="https://github.com/smswithoutborders/RelaySMS-iOS"
  />
</div>
